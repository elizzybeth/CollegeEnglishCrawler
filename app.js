        ...
        "callback":function(error,result,$) {
            ...
            if(indexTest.test(result.request.uri.href)) {
                ...
                if(indexOriginal === result.request.uri.href) {
                    ...
                    console.log("On the original index page.");
                    // so queue all the other index pages
                    console.log("So queueing all the other index pages.");
                ...
                console.log("Reached the else! Saving article data.");
                // it's an article
